...
async function searchPlayer() {
    ...
    const playerIdFormatted = playerInput.replace('#', '-');
    ...
    try {
        ...
        if (player.summary.competitive && player.summary.competitive.pc) {
            competitiveRanks = Object.entries(player.summary.competitive.pc)
                ...
                .map(function(entry) {
                    ...
                    return '<div class="mb-2">' +
                        ...
                        '<img src="' + rank.rank_icon + '" alt="' + role + ' rank" class="w-8 h-8 inline-block">' +
                    '</div>';
                }).join('');
        }
        ...
        resultDiv.innerHTML = 
            ...
            '<h4 class="font-bold mt-4">Competitive Ranks (PC):</h4>' +
